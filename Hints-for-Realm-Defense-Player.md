...
+ 锦标赛周一早上结算，结算后再予奖励和晋升，并休息一天，之后会更换锦标赛地图。段位（league）包含**铜**（bronze），**银**（sliver），**金**（gold，可开启三地图），**白金**（platinum），**钻石**（diamond），**大师**（master），**传奇**（legendary，前三称为**宗师**，grandmaster，**缩写[GM]**）。任务中的段位升级（仅第一次）能获得大量钻石和圣水。
